...
public final class CpsCounterModule extends Module {
    public CpsCounterModule() {
        super("cpscounter", "CPSCounter", "Show left/right clicks per second.", ModuleCategory.HUD, true);
    }
    ...
    public void onHudRender(DrawContext ctx) {
        ...
        String text = HudCache.get(
            "cpscounter:text",
            () -> "CPS: " + InputTracker.CLICKS.getLeftCps() + " | " + InputTracker.CLICKS.getRightCps()
        );
